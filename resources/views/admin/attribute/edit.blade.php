<div class="modal fade" id="modal-edit-attribute" style="--bs-modal-width:50%" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content"
            ...
            <div class="modal-header" style="background: #5e72e4">
                <h4 class="modal-title" style="color: white" id="myModalLabel">Sửa thuộc tính</h4>
                <button
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slug" onkeyup="ChangeToSlug();"
                                   placeholder="Điền tên attriute" value="{{$attribute->value}}" name="value">
                            <div class="text-danger error-text value_error"></div>
                        </div>
                        <div class="form-group">
                            <label for="exampleName">Slug thuộc tính</label>
                            <input type="text" class="form-control" value="{{$attribute->slug}}" id="convert_slug"
                                   name="slug">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-edit-attribute">Sửa</button>
            </div>
        </div>
    </div>
