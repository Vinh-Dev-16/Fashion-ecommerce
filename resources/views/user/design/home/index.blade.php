...
@section('content')
    ...
    <div class="flex home_user  "
         style="background-image: url({{ asset('images/bg1.jpg') }});  filter: brightness(0.9);">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="price">
                                            <span
                                                ...
                                                VND</span>
                                            <span
                                                class="normal mini_text">{{ number_format($product->price) }} VND</span>
                                        </div>
                                        <div class="stock mini_text">
                                            <div class="qty">
                                                ...
                                                <span>Đã bán: <strong
                                                        class="qty_sold">{{$product->sold}}</strong></span>
                                            </div>
                                            <div class="bar">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="price">
                                                ...
                                                @else
                                                    <span
                                                        class="current">{{ number_format($product->price) }} VND</span>
                                                @endif
                                            </div>
                                            <div class="mini_text">
...
@endsection
@section('javascript')
 @include('user.design.home.script')
@endsection
