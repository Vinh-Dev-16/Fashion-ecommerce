    ...
    <div class="single_checkout">
        <div class="container">
            <div class="wrapper">
                ...
                @if(App\Models\OrderDetail::where('status',2)->count() > 0)
                            ...
                            <form action="{{url('confirm')}}" method="POST">
                                ...
                                <table id="cart_table">
                                    <thead>
                                        <tr>
                                            <th>
                                            <button style="border:none; outline:none;font-size:16px;font-weight:600" type="submit">Xác nhận </button> 
                                            </th>
                                            <th>Sản phẩm</th>
                                            <th>Giá</th>
                                            <th>Số lượng</th>
                                    ...
                                    <tbody>
                                            @foreach (App\Models\OrderDetail::where('status',2)->get() as $orderItem)
