        ...
        <div class="content">
          ...
          <form action="{{url('information/update/'. $user->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div>
              ...
              <img src="{{asset('storage/avatar/' . $user->information->avatar)}}" style="width:13%; margin: 1em 0">
            </div>
            <div class="gender-details">
              <input type="radio" name="gender" value="male"  {{'male' == $user->information->gender ? 'checked' : ''}} id="dot-1">
              <input type="radio" name="gender" value="female" {{'female' == $user->information->gender ? 'checked' : ''}} id="dot-2">
              <span class="gender-title">Gender</span>
              <div class="category">
              <label for="gender">Male</label>
              <input style="display: block"  type="radio" name="gender" {{ 'male' == $user->information->gender ? 'checked' : ''}} value="male">
              <label for="gender">Female</label>
              <input style="display: block" type="radio" name="gender" {{ 'female' == $user->information->gender ? 'checked' : ''}} value="female">
              </div>
            </div>
            <div class="button">
